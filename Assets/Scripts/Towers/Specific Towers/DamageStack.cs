...
public class DamageStack: InGameTower {
    ...
    void causeDamage(Collider c)
    {
        ...
        c.gameObject.GetComponent<Enemy>().Health.AddModifier(new Keith.EnemyStats.StatModifier(-damage.Value * (1+hitCount*percentageAddPerHit), Keith.EnemyStats.StatModType.Flat));
